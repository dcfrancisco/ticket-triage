...
- Optional: pgvector (for embeddings) — behind a feature flag; provide a non-vector fallback.
- OpenAI client via Spring AI *or* a simple HTTP client wrapper (choose simplest, keep isolated).
...
- Infrastructure contains:
  ...
  - External AI client implementation
  - Vector/embedding storage adapter (optional)
...
- Core endpoints:
  ...
  - GET /api/tickets/{id}/similar (optional embeddings)
